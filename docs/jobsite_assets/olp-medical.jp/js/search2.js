$(function() {
  ...
  $('#srh_ken_param,.srh_ken_param,#srh_city_param,.srh_city_param,.srh_jobtype_child_param,.srh_shift_param,.srh_room_type_param,.sfw,.sfw1').on('change', function() {
    var srh_ken_param = $('#srh_ken_param:selectedIndex,.srh_ken_param:selectedIndex').map(function() {
      return $(this).val();
    }).get();
    var srh_city_param = $('#srh_city_param,.srh_city_param').map(function() {
      return $(this).val();
    }).get();
    ...
    $('#test').prop('href', href + "?fuseaction=job.joblist&srh_ken_param=" + srh_ken_param + "&srh_city_param=" + srh_city_param + "&srh_jobtype_child_param=" + srh_jobtype_child_param + "&srh_shift_param=" + srh_shift_param + "&srh_room_type_param=" + srh_room_type_param + "&sfw=" + sfw );
  });
});
  ...
  var e = function() {
      ...
      return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, i = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function(e, t) {
        ...
        return e.prototype.render = function(e) {
          var t = r('<li class="select2-search select2-search--inline">');
