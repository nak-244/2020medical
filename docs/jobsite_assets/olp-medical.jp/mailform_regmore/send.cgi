...
$conf{'thanks'} = 'https://olp-medical.jp/index.cfm?fuseaction=contents.fcts&cid=367';

#08.設置者に届くメールの件名
$conf{'subject'} = '【メジョモ】スタッフ詳細登録を受け付けました';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '【メジョモ】スタッフ詳細登録ありがとうございました';
...
この度は【メジョモ】より詳細登録をしていただき、誠にありがとうございます。

ご希望の条件、今までのご経歴を参考にさせていただき、より条件にマッチした求人情報をお送りいたします。

━━━━━━━━━━━━━━━━━━━━━━━━━━
お時間ある場合は、下記求人サイトより、お好みの求人をお探しください。

https://olp-medical.jp/
