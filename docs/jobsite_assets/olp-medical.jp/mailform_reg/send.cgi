...
#09.送信者に届くメールの件名
$conf{'res_subject'} = '【メジョモ】スタッフ簡易登録ありがとうございました';
...
この度は【メジョモ】より簡易登録をしていただき、誠にありがとうございます。

お時間がございましたら、下記URLより詳細登録を推奨しています。
...
━━━━━━━━━━━━━━━━━━━━━━━━━━
下記求人サイトより、お好みの求人をお探しください。

https://olp-medical.jp/



弊社からも不定期にはなりますが、ご希望の条件に沿った求人情報を
メールにて配信をさせていただきます。
